...
//        return BlockBehaviour.Properties.copy(Blocks.GRASS).mapColor(MapColor.WARPED_WART_BLOCK).strength(0.2f).sound(SoundType.HONEY_BLOCK);
//    }
//
//    @Override
...
//                        if (level.getBlockState(ringPos.below()).is(dtbwgRegistries.FUNGAL_IMPARIUS_FILAMENT.get())){
//                            level.setBlock(ringPos.below(), Blocks.AIR.defaultBlockState(), 2);
//                        }
...
//                            level.setBlock(ringPos.below(), dtbwgRegistries.FUNGAL_IMPARIUS_FILAMENT.get().defaultBlockState(), 2);
//                        }
//                        ++placed;
//                    } else {
//                        ++notPlaced;
