...
//                        if (level.getBlockState(ringPos.above()).is(dtbwgRegistries.IMPARIUS_MUSHROOM_BRANCH.get())){
...
//                                level.setBlock(ringPos.above(), dtbwgRegistries.IMPARIUS_MUSHROOM_BRANCH.get().defaultBlockState().setValue(TreeBranchBlock.FACING, facing.getOpposite()), 2);
//                            }
//                        }
//                        ++placed;
//                    } else {
